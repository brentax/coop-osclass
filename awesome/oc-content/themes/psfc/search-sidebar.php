...
<div class="filters">
    <form action="<?php echo osc_base_url(true); ?>" method="get" class="nocsrf">
        ...
        <fieldset>
            <h3><?php _e('Show only', 'psfc') ; ?></h3>
            <div class="row">
                <input type="checkbox" name="bPic" id="withPicture" value="1" <?php echo (osc_search_has_pic() ? 'checked' : ''); ?> />
                <label for="withPicture"><?php _e('listings with pictures', 'psfc') ; ?></label>
            </div>
        </fieldset>
        <?php } ?>
        ...
        <fieldset>
            <div class="row price-slice">
                <h3><?php _e('Price', 'psfc') ; ?></h3>
                <span><?php _e('Min', 'psfc') ; ?>.</span>
        ...
        <?php } ?>
        <div class="actions">
            <button type="submit"><?php _e('Apply', 'psfc') ; ?></button>
        </div>
    </form>
    <fieldset>
        <div class="row ">
            <h3><?php _e('Refine category', 'psfc') ; ?></h3>
            <?php psfc_sidebar_category_search($category['pk_i_id']); ?>
        </div>
    </fieldset>
</div>
</div>