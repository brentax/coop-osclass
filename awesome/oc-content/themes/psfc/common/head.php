...
<?php
    $js_lang = array(
        'delete' => __('Delete', 'psfc'),
        'cancel' => __('Cancel', 'psfc')
    );
...
<script type="text/javascript">
    var psfc = window.psfc || {};
    psfc.base_url = '<?php echo osc_base_url(true); ?>';
    psfc.langs = <?php echo json_encode($js_lang); ?>;
    psfc.fancybox_prev = '<?php echo osc_esc_js( __('Previous image','psfc')) ?>';
    psfc.fancybox_next = '<?php echo osc_esc_js( __('Next image','psfc')) ?>';
    psfc.fancybox_closeBtn = '<?php echo osc_esc_js( __('Close','psfc')) ?>';
</script>
